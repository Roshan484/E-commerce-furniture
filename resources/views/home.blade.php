<x-app-layout>
    ...
    <!-- categories -->
    <div class="container py-16">
        <h2 class="text-2xl font-medium text-white uppercase mb-6">Shop by category</h2>
    ...
    <div class="container pb-16">
        <h2 class="text-2xl font-medium  uppercase mb-6">Top new arrival</h2>
    ...
    <!-- product -->
    <div class="container pb-16">
        <h2 class="text-2xl font-medium  uppercase mb-6">Recomended for you</h2>
